...
![Page Visits](https://komarev.com/ghpvc/?username=kalpit118&repo=CopyAlert&color=7C3AED&style=flat-square&label=PAGE%20VISITS)
...
1. **Download**: Grab the latest release from the [Releases](https://github.com/kalpit118/CopyAlert/releases) page.
2. **Install**: Right-click **`Setup.ps1`** and select **Run with PowerShell**. This will:
   - Install CopyAlert to your local apps folder.
   - Create a Desktop shortcut.
   - Create a Start Menu shortcut.
3. **Alternative**: You can also just run **`CopyAlert.exe`** directly if you prefer not to install it.
